            ...
            <div className="flex flex-col gap-4 sm:gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground text-sm sm:text-base text-balance">
                  Login to your My Little World account
                </p>
              </div>
              ...
              {/* <div className="after:top-1/2 after:absolute relative after:inset-0 after:flex after:items-center after:border-t after:border-border text-xs sm:text-sm text-center">
                <span className="z-1 relative bg-background px-2 text-muted-foreground">
                  Or continue with
                </span>
              </div>
